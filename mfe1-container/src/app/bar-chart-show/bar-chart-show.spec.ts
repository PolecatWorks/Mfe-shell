...
import { BarChartShow } from './bar-chart-show';
import { CommonModule } from '@angular/common';
import { SimpleChange } from '@angular/core';

describe('BarChartShow', () => {
  let component: BarChartShow;
  let fixture: ComponentFixture<BarChartShow>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CommonModule, BarChartShow]
    })
    .compileComponents();

    fixture = TestBed.createComponent(BarChartShow);
